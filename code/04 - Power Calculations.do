...
tempname results
postfile `results' str40 crop str40 outcome str40 num_farmers str40 num_clusters mean icc sd detectable_difference attrition_percentage str40 results_unit str40 icc_defined using "${github}/output/power_calculations_results.dta", replace
				...
				foreach results_unit in "Kg or Kg per Hec" "Multiples of SD" "Percentage Increase" {
					forvalues num_clusters = 13(10)83 {
						foreach icc_defined in "Yes" "No" {
							...
							clustersampsi, detectabledifference mu1(`_mean') sd1(`sd') m(`num_farmers_real') k(`num_clusters') rho(`_icc')
							...
							// Save results
							post `results' ("`crop'") ("`outcome'") ("`num_farmers_string'") ("`num_clusters_string'") (`_mean') (`_icc') (`sd') (`dd') (`attrition_rate' * 100) ("`results_unit'") ("`icc_defined'")
							restore	
